...
public class WF113 {
    ...
    private String login = "fixexy@nada.ltd";
    ...
    public void setUp() {
        ...
        System.out.println("Verify that SU can Sign Out");
    ...
    public void test() throws Exception {
        ...
        System.out.println("SU should be redirected to Homepage");
        ...
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF113.png"));
