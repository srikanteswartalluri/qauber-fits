...
public class WF172 {
    ...
    private String expectedText = "The password has been changed.";
    ...
    public void test() throws Exception {
        ...
        driver.findElement(newrepeatfield).sendKeys(newRepeat);

        System.out.println("Press button \"Change\"");
        driver.findElement(clickchange).click();
        Thread.sleep(5000);
        actualText = driver.findElement(By.xpath("/html/body/div[3]/div")).getText();
        ...
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF172.png"));
