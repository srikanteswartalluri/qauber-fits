...
public class WF109 {
    ...
    private By clickOnView = By.xpath("//div/a[@class='btn btn-info btn-sm mt-sm ng-scope'][1]");
    private By infoHeader = By.xpath("//div[@class='panel-heading']");
    ...
    public void setUp() {
        ...
        System.out.println("Verify AU can click on \"View\" button on the Report page");
    ...
    public void test() throws Exception {
        ...
        System.out.println("Select in the \"Search Results\" section the reported person");

        driver.findElement(clickOnView).click();
        System.out.println("Click on \"View \" button");

        driver.findElement(infoHeader).click();
        System.out.println("AU should be redirected to Report Information page");


        TakesScreenshot ts =(TakesScreenshot)driver;
        File source = ts.getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF109.png"));
