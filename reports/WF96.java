...
public class WF96 {
    ...
    private String login = "lypezo@wmail.club";
    ...
    public void setUp() {
        ...
        System.out.println("Verify that RU can view the report");
    ...
    public void test() throws Exception {
        ...
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF96.png"));
